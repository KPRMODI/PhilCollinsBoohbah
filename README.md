...
### 🚀 [PLAY THE GAME NOW](https://kprmodi.github.io/PhilCollinsBoohbah/)
...
2. **Open the Files:** Simply launch `index.html` in any modern browser.
3. **Contribute:** Found a bug? Want to add a Peter Gabriel cameo? Feel free to open a Pull Request.

---

> *"I've been waiting for this moment all my life... mostly because I forgot to pack a map of the galaxy."* — Phil Collins, probably.

**Created by [KPRMODI**](https://www.google.com/search?q=https://github.com/KPRMODI)
